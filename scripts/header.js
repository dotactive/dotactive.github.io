myapp.component('topbar', {
    ...
    <div></div>
    <div class="cn-switch"><button @click="toggleChinese" :title="isSimplified ? '切换到繁体' : '切換到簡體'">
    <span v-if="isSimplified">简</span>
    <span v-else>繁</span>
    </button></div>
    ...
    data() {
      return {
        ...
        isSettingOpen: false,
        nightMode:false,
        isSimplified: true // Default to simplified Chinese
      };
    },
    methods: {
      ...
      updateFontSize() {
        ...
        toggleChinese(){
          ...
          this.$emit('chinese-mode', this.isSimplified);
        },
        handleScroll() {
